-- Phase 4.B: authorized persistent Classroom Overview projection.
-- The linked learning schedule is read-only context in this slice. Phase 5
-- owns required Schedule creation, version activation, editing, and Course-date
-- synchronization.
...
comment on function public.get_my_classroom_space(uuid) is
  'Authorized Phase 4.B persistent Classroom Overview with Course participants, provider model, and read-only linked Schedule summary. Schedule mutations remain in Phase 5.';
