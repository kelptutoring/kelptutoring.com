-- Forward hotfix for databases that already applied 202607240001.
-- PostgreSQL treated the original local variable `classroom_id` as ambiguous
-- beside table columns with the same name. Keep the contract unchanged and
-- give the local value an explicit, non-colliding identity.
